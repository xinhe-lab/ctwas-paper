...
This repo includes code to reproduce the analysis results presented in the ctwas paper:
...
The `ctwas` R package can be accessed [here](https://github.com/xinhe-lab/ctwas). 
