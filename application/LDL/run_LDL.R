...
args <- c("/project2/compbio/gwas_summary_statistics/ukbb_neale_v3/ukb-d-30780_irnt.vcf",
          "/project2/mstephens/wcrouse/UKB_LDR_0.1",
          "/project2/mstephens/wcrouse/predictdb/mashr_Liver_nolnc.db",
          "/project2/mstephens/wcrouse/UKB_analysis_known_anno/ctwas_config.R",
          "ukb-d-30780_irnt_Liver_expr",
          "ukb-d-30780_irnt_Liver_ctwas",
          "/project2/mstephens/wcrouse/UKB_analysis_known_anno/ukb-d-30780_irnt/Liver_nolnc_corrected")
