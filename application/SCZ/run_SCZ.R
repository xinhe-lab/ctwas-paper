...
# args <- c("/project2/xinhe/shengqian/cTWAS/cTWAS_analysis/data/scz_2018.RDS",
...
#           "scz-2018_Spleen_expr",
#           "scz-2018_Spleen_ctwas",
#           "/project2/mstephens/wcrouse/UKB_analysis_allweights_scz/scz-2018/Spleen_nolnc")
...
if (file.exists(z_snp_outfile)){
  ...
  z_snp <- readRDS(args[1])

  z_snp$Z <- z_snp$logOR/z_snp$SE
  z_snp["SS"] <- 105318
  z_snp <- z_snp[,c("SNP", "A1", "A2", "Z", "SS")]
